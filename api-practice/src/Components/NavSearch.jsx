...
export default function () {
    return (
        <div className="w-11/12 mx-auto flex justify-between items-baseline">
            <Link to='/'>
                <div className=" relative text-[#CB0F22] font-bold text-4xl underline py-1 w-fit">INDIA TODAY</div>
            </Link>
            ...
            <div className="flex flex-row items-center gap-4">
                <div className="cursor-pointer px-2 flex items-center flex-col">
                    ...
                    <span className="text-[10px]">Magzine</span>
                </div>
                <div className="cursor-pointer px-2 flex items-center flex-col">
                    <MdLiveTv />
                    <span className="text-[10px] mt-[-2px]">Live TV</span>
                </div>
                <div className="cursor-pointer px-2 flex items-center flex-col">
                <CiSearch />
